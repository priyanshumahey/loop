...
export interface UseSidebarResizeProps {
  ...
  /**
   * Auto-collapse threshold as a multiple of minResizeWidth. A value of 1.5
   * means the panel collapses when dragged 50% beyond the minimum width.
   */
  autoCollapseThreshold?: number

  /** Threshold to expand when dragging in the opposite direction (0.0-1.0) */
 ...
 * Works for both sidebar (left side) and panel (right side) surfaces.
