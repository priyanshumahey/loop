...
const icons = {
  explain: <CircleHelpIcon {...iconProps} />,
  improve: <SparklesIcon {...iconProps} />,
  shorten: <ScissorsIcon {...iconProps} />,
  tone: <SmileIcon {...iconProps} />,
  grammar: <TextCursorInputIcon {...iconProps} />,
  send: (
    <ArrowUpIcon
      width="16"
      height="16"
  ...
  chevron: <ChevronRightIcon {...iconProps} />,
  check: <CheckIcon {...iconProps} />,
  close: <XIcon {...iconProps} />,
  retry: <RefreshCwIcon {...iconProps} />,
};
    ...
    <div className="w-full max-w-[460px]">
      <div ref={hostRef} className="relative select-none pb-12">
        <p className="text-[13px] leading-relaxed text-ink">
          ...
          <span
            ref={selectionRef}
            className="box-decoration-clone rounded-[3px] bg-[color-mix(in_srgb,var(--brand)_14%,var(--surface))] text-ink dark:bg-accent-tint"
          >
