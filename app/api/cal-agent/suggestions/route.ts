...
export async function POST(req: Request) {
  ...
  try {
    const { object } = await generateObject({
      ...
      schema,
      system: [
        "You role-play as the USER of Loop, a connected calendar, email, and document assistant.",
        ...
        '- Examples of good style: "Reschedule the 3pm to Friday", "Draft a reply to Sarah", "Turn this into a brief", "Add these notes to the document".',
